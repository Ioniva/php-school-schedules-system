...
class Student extends Controllers
{
    ...
    public function setStudent()
    {
        ...
        if ($_POST) {
            ...
            if (empty($_POST['name']) || empty($_POST['surname']) || empty($_POST['username']) || empty($_POST['email']) || empty($_POST['phone']) || empty($_POST['nif'])) {
                ...
                if ($id == 0) {
                    ...
                    $request_user = $this->model->insertStudent($name, $surname, $username, $email, $phone, $nif, $password);
                } else {
                    // Actualizar alumno
                    $option = 2;
                    ...
                    // Guardar en variable el valor recibido del modelo
                    $request_user = $this->model->updateStudent($id, $name, $surname, $username, $email, $phone, $nif, $password);
                }
    ...
    public function getStudent(int $id)
    {
        ...
        if ($idStudent > 0) {
            ...
            // Guardar en variable el valor recibido del modelo
            $arrData = $this->model->selectStudent($idStudent);
    ...
    public function delStudent()
    {
        ...
        if ($_POST) {
            ...
            // Guardar en variable el valor recibido del modelo
            $requestDelete = $this->model->deleteStudent($intId);
