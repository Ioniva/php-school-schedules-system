...
<head>
 ...
 <script defer src="public/js/functions_admin.js"></script>
 <!-- Sweetalert2 script -->
             ...
             <div class="container-fluid">
                 <div class="row mb-2">
                     <div class="col-sm-6 container-header">
                         <h1>Admin</h1>
                         <button type="button" class="btn btn-primary ml-3" id="btnCreateAdmin" onclick="openModal()">
                             New Admin
                         </button>
                     </div>
                     <div class="col-sm-6">
                                     ...
                                     <?php for ($i = 0; $i < count($data); $i++) : ?>
                                         <tr>
                                             ...
                                             <td class="project-actions text-right">
                                                 ...
                                                 <button type="button" class="btn btn-info btn-flat ml-4" id="btn-edit" onclick="fntEditAdmin(<?= $data[$i]['id_user_admin']; ?>)">
                                                     <em class="fas fa-pencil-alt"></em>
                                                     Edit
                                                 </button>
                                                 <button type="button" class="btn btn-danger btn-flat ml-4" id="btn-delete" onclick="fntDelAdmin(<?= $data[$i]['id_user_admin']; ?>)">
