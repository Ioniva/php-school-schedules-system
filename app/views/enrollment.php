...
<head>
 ...
 <title>PHPeros | Enrollment</title>
 ...
 <script defer src="public/js/functions_enrollment.js"></script>
 <!-- Sweetalert2 script -->
             ...
             <div class="container-fluid">
                 <div class="row mb-2">
                     <div class="col-sm-6 container-header">
                         <h1>Enrollment</h1>
                         <button type="button" class="btn btn-primary ml-3" id="btnCreateEnrollment" onclick="openModal()">
                             New Enrollment
                         </button>
                     </div>
                     <div class="col-sm-6">
                             ...
                             <table id="example1" class="table table-bordered table-striped dataTable dtr-inline" aria-describedby="example1_info">
                                 <thead>
                                     <tr>
                                         ...
                                         <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending">Student ID</th>
                                     ...
                                     <?php for ($i = 0; $i < count($data); $i++) : ?>
                                         <tr>
                                             ...
                                             <td class="project-actions text-right">
                                                 ...
                                                 <button type="button" class="btn btn-info btn-flat ml-4" id="btn-edit" onclick="fntEditEnrollment(<?= $data[$i]['id_enrollment']; ?>)">
                                                     <em class="fas fa-pencil-alt"></em>
                                                     Edit
                                                 </button>
                                                 <button type="button" class="btn btn-danger btn-flat ml-4" id="btn-delete" onclick="fntDelEnrollment(<?= $data[$i]['id_enrollment']; ?>)">
