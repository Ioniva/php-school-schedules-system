...
<head>
    ...
    <script defer src="public/js/functions_course.js"></script>
    <!-- Sweetalert2 script -->
                ...
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6 container-header">
                            <h1>Course</h1>
                            <button type="button" class="btn btn-primary ml-3" id="btnCreateCourse" onclick="openModal()">
                                New Course
                            </button>
                        </div>
                        <div class="col-sm-6">
                                ...
                                <table id="example1" class="table table-bordered table-striped dataTable dtr-inline" aria-describedby="example1_info">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="CSS grade: activate to sort column ascending">End date</th>
                                        ...
                                        <?php for ($i = 0; $i < count($data); $i++) : ?>
                                            <tr>
                                                ...
                                                <td class="project-actions text-right">
                                                    ...
                                                    <button type="button" class="btn btn-info btn-flat ml-4" id="btn-edit" onclick="fntEditCourse(<?= $data[$i]['id_course']; ?>)">
                                                        <em class="fas fa-pencil-alt"></em>
                                                        Edit
                                                    </button>
                                                    <button type="button" class="btn btn-danger btn-flat ml-4" id="btn-delete" onclick="fntDelCourse(<?= $data[$i]['id_course']; ?>)">
