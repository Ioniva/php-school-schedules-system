...
<head>
    ...
    <script defer src="public/js/functions_subject.js"></script>
    <!-- Sweetalert2 script -->
                ...
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6 container-header">
                            <h1>Subject</h1>
                            <button type="button" class="btn btn-primary ml-3" id="btnCreateSubject" onclick="openModal()">
                                New Subject
                            </button>
                        </div>
                        <div class="col-sm-6">
                                ...
                                <table id="example1" class="table table-bordered table-striped dataTable dtr-inline" aria-describedby="example1_info">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending">Teacher ID</th>
                                            <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending">Course ID</th>
                                            <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="CSS grade: activate to sort column ascending">Schedule ID</th>
                                            <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="CSS grade: activate to sort column ascending">Name</th>
                                            <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="CSS grade: activate to sort column ascending">Color</th>
                                        ...
                                        <?php for ($i = 0; $i < count($data); $i++) : ?>
                                            <tr>
                                                ...
                                                <td class="project-actions text-right">
                                                    ...
                                                    <button type="button" class="btn btn-info btn-flat ml-4" id="btn-edit" onclick="fntEditSubject(<?= $data[$i]['id_class']; ?>)">
                                                        <em class="fas fa-pencil-alt"></em>
                                                        Edit
                                                    </button>
                                                    <button type="button" class="btn btn-danger btn-flat ml-4" id="btn-delete" onclick="fntDelSubject(<?= $data[$i]['id_class']; ?>)">
