 ...
 <head>
     ...
     <script defer src="public/js/functions_student.js"></script>
     <!-- Sweetalert2 script -->
                 ...
                 <div class="container-fluid">
                     <div class="row mb-2">
                         <div class="col-sm-6 container-header">
                             <h1>Student</h1>
                             <button type="button" class="btn btn-primary ml-3" id="btnCreateStudent" onclick="openModal()">
                                 New Student
                             </button>
                         </div>
                         <div class="col-sm-6">
                                 ...
                                 <table id="example1" class="table table-bordered table-striped dataTable dtr-inline" aria-describedby="example1_info">
                                     <thead>
                                         <tr>
                                             ...
                                             <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Engine version: activate to sort column ascending">Username</th>
                                             ...
                                             <th class="sorting" tabindex="0" aria-controls="example1" rows#an="1" colspan="1" aria-label="CSS grade: activate to sort column ascending">Date Registered</th>
                                         ...
                                         <?php for ($i = 0; $i < count($data); $i++) : ?>
                                             <tr>
                                                 ...
                                                 <td class="project-actions text-right">
                                                     ...
                                                     <button type="button" class="btn btn-info btn-flat ml-4" id="btn-edit" onclick="fntEditStudent(<?= $data[$i]['id']; ?>)">
                                                         <em class="fas fa-pencil-alt"></em>
                                                         Edit
                                                     </button>
                                                     <button type="button" class="btn btn-danger btn-flat ml-4" id="btn-delete" onclick="fntDelStudent(<?= $data[$i]['id']; ?>)">
