...
<head>
    ...
    <script defer src="public/js/functions_schedule.js"></script>
    <!-- Sweetalert2 script -->
                ...
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6 container-header">
                            <h1>Schedule</h1>
                            <button type="button" class="btn btn-primary ml-3" id="btnCreateSchedule" onclick="openModal()">
                                New Schedule
                            </button>
                        </div>
                        <div class="col-sm-6">
                                ...
                                <table id="example1" class="table table-bordered table-striped dataTable dtr-inline" aria-describedby="example1_info">
                                    ...
                                    <tbody>
                                        <?php for ($i = 0; $i < count($data); $i++) : ?>
                                            <tr>
                                                <td>#</td>
                                                <td><?= $data[$i]['time_start'] ?></td>
                                                <td><?= $data[$i]['time_end'] ?></td>
                                                <td><?= $data[$i]['day'] ?></td>
                                                </td>
                                                <td class="project-actions text-right">
                                                    ...
                                                    <button type="button" class="btn btn-info btn-flat ml-4" id="btn-edit" onclick="fntEditSchedule(<?= $data[$i]['id_schedule']; ?>)">
                                                        <em class="fas fa-pencil-alt"></em>
                                                        Edit
                                                    </button>
                                                    <button type="button" class="btn btn-danger btn-flat ml-4" id="btn-delete" onclick="fntDelSchedule(<?= $data[$i]['id_schedule']; ?>)">
